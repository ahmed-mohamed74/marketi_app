...
class SearchSectionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text('What are you looking for?', style: Theme.of(context).textTheme.labelLarge),
    );
  }
}
      ...
      builder: (context, setState) {
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              if (query.isEmpty) ...[
                _sectionHeader('Popular Search',context),
                _buildPopularChips(context),
                if (searchHistory.isNotEmpty) ...[
                  _sectionHeader('Search History',context),
