...
import 'package:marketi_app/features/auth/presentation/widgets/pin_code_field.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leadingWidth: 64,
        title: Text('Verification Code', style: theme.textTheme.titleLarge),
        centerTitle: true,
      ),
      body: BlocConsumer<AuthBloc, AuthState>(
        listener: (context, state) {
          if (state is AuthFailure) {
            ...
            context.push(AppRoutes.newPasswordPage, extra: widget.email);
          }
        },
